...
import pytest
from aoc2025.days import day05


@pytest.fixture
def example_input(load_example):
    """Load the example input for day 05."""
    return load_example(5)
...
class TestPart1:
    ...
    def test_example(self, example_input):
        ...
        result = day05.part_one(example_input)
...
class TestPart2:
    ...
    def test_example(self, example_input):
        ...
        # TODO: Update expected value from puzzle description
        result = day05.part_two(example_input)
        assert result == 14  # Replace with expected value
